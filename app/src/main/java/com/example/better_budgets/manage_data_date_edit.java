...
public class manage_data_date_edit extends AppCompatActivity {
    Integer spendingid;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manage_data_date_edit);

        EditText editId = findViewById(R.id.editText_md_date_edit_id);
        EditText editDate = findViewById(R.id.editText_md_date_edit_date);
        EditText editSource = findViewById(R.id.editText_md_date_edit_source);
        EditText editAmount = findViewById(R.id.editText_md_date_edit_amount);
        EditText editSeller = findViewById(R.id.editText_md_date_edit_seller);
